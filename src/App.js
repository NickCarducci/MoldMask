...
export default function App() {
  return (
    ...
    >
      ...
      <br />
      You cannot force, ban or move people to do something not on an individual
      basis; you're of the choice to go visit someplace or not, and territories
      can disclude and not be a societal-free-rider if there are visible
      symptoms, or by a non-invasive temperature check
      <br />
      <br />
      "No benefit of monoclonal antibodies after visiting a hospital nest, have
      to make your own with mRNA without using your own punches,&nbsp;
      ...
      <div style={{ display: "inline-block" }}>
        ...
        &nbsp; to sell these things, with only correlations that they do (which
        can be because of age of population or intentional poisoning)
      </div>
      <br />
      <br />
      <div
      ...
      &nbsp;(to say lockdown are required now that someone has the PCR for cold
      is laughable. The root cause of hostility towards Asians is lockdowns and
      the Duke U hostility towards lockdown orders is not cases of Poly-Chain
      Reaction to cold, it is because you do not understand&nbsp;
